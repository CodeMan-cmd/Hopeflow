...
5. **二次元为锚** — 所有变体必须保持东方奇幻质感，拒绝3D写实/CG动画感；保留细腻线条、赛璐璐平涂、动漫渲染
...
| 特写 | 极局部细节 | 材质纹理/法阵符文 | extreme closeup、特写 |
...
| 时段 | 视觉特征 | 提示词 |
|---|---|---|
| 清晨 | 薄雾柔光、灵光微亮 | 晨雾缭绕、灵光微熹 |
| 正午 | 明亮、阴影短、色彩鲜明 | 天光明亮、云海翻涌 |
| 黄昏 | 金色色调、长影、天空渐变 | 暮色鎏金、golden hour |
| 夜间（月光） | 冷蓝色调、幽静清冷 | 月光清辉、moonlight |
| 夜间（灵光） | 灵火/法光点缀、明暗对比 | 灵光点点、符文微亮 |
...
| 日间 → 夜间 | 建筑/布局/材质 | 整体变暗、增加月光/灵光氛围 |
| 室内日间 → 室内夜间 | 空间结构、家具 | 整体色调暖化、增加灵火/烛火元素 |
...
| 天候 | 视觉特征 | 提示词 |
|---|---|---|
| 晴天 | 明亮、阴影清晰 | 晴空万里、灵云舒展 |
| 云海 | 云雾翻涌、建筑浮现 | 云海翻腾、仙山浮现 |
| 薄雾/妖雾 | 能见度降低、空气朦胧 | 雾气弥漫、诡谲朦胧 |
| 灵雨 | 灵光雨丝、湿润反光 | 灵雨如丝、雨幕轻纱 |
| 妖风 | 气流卷动、草木低伏 | 妖风骤起、阴云低垂 |

### 天候衍生规范

| 从基准天候衍生 | 保持不变 | 变化项 |
|---|---|---|
| 晴 → 云海 | 建筑/布局 | 增加云层、远景模糊、饱和度降低 |
| 晴 → 灵雨 | 建筑/布局 | 增加雨丝、地面反光、色调偏冷 |
| 晴 → 妖雾 | 建筑/布局 | 增加雾气、色调偏绛紫暗调 |
| 植被需随天候逻辑适配 | — | 雨中灵花湿润、雾中古木隐现 |
...
| 俯视 | 高位俯瞰，呈现整体布局（如俯瞰法阵全貌） | high angle、bird's eye view |
| 仰视 | 低位仰望，强调悬浮山/仙宫高大主体 | low angle、worm's eye view |
...
| R8 | 必须包含东方奇幻关键词（Eastern fantasy / cel shading / fine brushstrokes） |
| R9 | 必须包含镜头光学特征（赛璐璐平涂 / 细腻线条 / 动漫渲染） |
