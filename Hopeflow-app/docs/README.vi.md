...
<div align="center">
  ...
  <p align="center">
    <a href="https://git.io/typing-svg" target="_blank">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=FFFFFF&center=true&vCenter=true&width=600&lines=Hopeflow;Nhà+máy+phim+ngắn+AI;Nhấc+ngón+tay%2C+tiểu+thuyết+thành+phim+trong+giây+lát!" />
        <img alt="Typing SVG" src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=000000&center=true&vCenter=true&width=600&lines=Hopeflow;Nhà+máy+phim+ngắn+AI;Nhấc+ngón+tay%2C+tiểu+thuyết+thành+phim+trong+giây+lát!" />
      </picture>
    </a>
  </p>
  ...
  <p align="center">
    <a href="https://github.com/HBAI-Ltd/Hopeflow-app/stargazers">
      <img src="https://img.shields.io/github/stars/HBAI-Ltd/Hopeflow-app?style=for-the-badge&logo=github" alt="Huy hiệu Sao" />
    </a>
  ...
  <p align="center">
    <a href="https://github.com/HBAI-Ltd/Hopeflow-app/network/members">
      <img src="https://img.shields.io/github/forks/HBAI-Ltd/Hopeflow-app?style=for-the-badge&logo=github&color=orange" alt="Huy hiệu Fork" />
    </a>
  ...
  <p align="center">
    <a href="https://github.com/HBAI-Ltd/Hopeflow-app/issues">
      <img src="https://img.shields.io/github/issues/HBAI-Ltd/Hopeflow-app?style=for-the-badge&color=F48D73" alt="Vấn đề" />
    </a>
    <a href="https://github.com/HBAI-Ltd/Hopeflow-app/graphs/contributors">
      <img src="https://img.shields.io/github/contributors/HBAI-Ltd/Hopeflow-app?style=for-the-badge&color=2088FF" alt="Người đóng góp" />
    </a>
    <a href="https://github.com/HBAI-Ltd/Hopeflow-app/commits">
      <img src="https://img.shields.io/github/last-commit/HBAI-Ltd/Hopeflow-app?style=for-the-badge&color=blueviolet" alt="Cam kết cuối" />
    </a>
  </p>
  <p align="center">
...
Hopeflow hỗ trợ giao diện các ngôn ngữ sau:
...
Hopeflow là một bàn làm việc AI dành cho sản xuất phim ngắn, xoay quanh quy trình "Lên kế hoạch → Viết kịch bản → Phân cảnh → Xuất phim" để tạo thành một vòng lặp hoàn chỉnh, đồng thời hỗ trợ quy trình sản xuất có thể bản địa hóa, có thể lập trình và liên tục cải tiến.
...
[![Hopeflow 12 phút bắt đầu nhanh với AI Video](./videoCover.jpg)](https://www.bilibili.com/video/BV1oXD7BqEqJ)

**Hopeflow 12 phút bắt đầu nhanh với AI Video**
...
Các ảnh chụp màn hình và video dưới đây đến từ một bản demo phim ngắn AI được tạo bằng Hopeflow, toàn bộ quá trình hoàn thành trong khoảng 2 giờ, bao gồm tạo kịch bản, làm phân cảnh và chỉnh sửa.
...
| :------: |:------------------------------------------------------------|:------------- |
| Windows | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Gói cài đặt chính thức |
| Linux | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Gói cài đặt chính thức |
| macOS | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Gói cài đặt chính thức |
...
docker run -d -p <cổng_local>:10588 -v <đường_dẫn_dữ_liệu_local>:/app/data Hopeflow
...
pm2 logs Hopeflow-app # Xem nhật ký
...
>
> **[Zhixing Cloud (AI Galaxy)](https://www.ai-galaxy.com/)** là **nhà cung cấp image thương mại được Hopeflow chính thức ủy quyền**, đã hợp pháp cài đặt, phân phối và hỗ trợ sử dụng thương mại toàn bộ image sản xuất phim ngắn AI của Hopeflow, **sẵn sàng sử dụng ngay, không cần triển khai thủ công**.
>
...
2. Chọn image: `windows10LTSCwin10_Hopeflow` - Tạo phiên bản (instance).
...
#### II. Giai đoạn cấu hình Hopeflow, khởi động ComfyUI

1. Trước tiên cấu hình mô hình mà Agent gọi: mở Hopeflow trên màn hình - Dịch vụ mô hình - Giao diện chuẩn OpenAI - điền khóa API và địa chỉ yêu cầu.
   ...
   - Sau khi nạp tiền, vào "Quản lý Key" - Tạo API mới, đặt tên là `Hopeflow` hoặc tên khác tùy ý, nhấp xác nhận và sao chép khóa API.
2. Quay lại bước 1, dán khóa API và địa chỉ yêu cầu đã tạo vào Dịch vụ mô hình của Hopeflow, điền xong nhấp vào chỗ trống, hệ thống sẽ hiển thị "Cấu hình nhà cung cấp đã được cập nhật".
   ...
   Dán tên mô hình đầy đủ vào Hopeflow và xác nhận để hoàn tất cấu hình mô hình.
...
>
> Chào mừng các nhà phát triển cùng tham gia xây dựng Hopeflow. Nếu có hứng thú tham gia, vui lòng liên hệ quản lý ACT qua email.
...
- **pnpm**: Khuyến nghị sử dụng làm trình quản lý gói cho dự án
...
3. **Khởi động môi trường phát triển**
   ...
   - **Cách 3: Khởi động chế độ sản xuất**
     ...
     > Chạy trực tiếp dịch vụ đã biên dịch ở chế độ sản xuất (cần thực hiện `pnpm build` trước).
...
| ---------------- | ---------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **Hopeflow-app** | Ứng dụng đầy đủ (kho lưu trữ này, khuyến nghị cho người dùng thông thường) | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-app) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-app) |
| **Hopeflow-web** | Mã nguồn frontend (phù hợp với nhà phát triển frontend) | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-web) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-web) |

> 💡 **Gợi ý**: Nếu bạn chỉ muốn sử dụng Hopeflow, hãy tải trực tiếp ứng dụng từ kho lưu trữ này. Kho lưu trữ frontend chỉ dành cho các nhà phát triển cần phát triển thứ cấp hoặc tùy chỉnh giao diện frontend.

---

# 💌 Liên hệ với chúng tôi

📧 Email: [ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=Hopeflow咨询)

---

# 📜 Giấy phép

Hopeflow được phát hành dưới dạng mã nguồn mở dựa trên giấy phép Apache-2.0, kèm theo thỏa thuận thương mại bổ sung.
...
- Không được xóa hoặc sửa đổi nhãn hiệu hoặc thông tin bản quyền trong Hopeflow.

## Kịch bản miễn phí vĩnh viễn

- ✅ Sử dụng Hopeflow để tạo nội dung và nhận chia sẻ doanh thu từ nền tảng
...
Cảm ơn các dự án mã nguồn mở sau đã cung cấp hỗ trợ mạnh mẽ cho Hopeflow:
...
Cảm ơn các tổ chức/đơn vị/cá nhân sau đã cung cấp hỗ trợ cho Hopeflow:
