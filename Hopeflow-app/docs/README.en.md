...
<div align="center">
  ...
  <p align="center">
    <a href="https://git.io/typing-svg" target="_blank">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=FFFFFF&center=true&vCenter=true&width=600&lines=Hopeflow;AI+Short+Drama+Factory;Just+a+click%2C+novels+turn+into+episodes+in+seconds!" />
        <img alt="Typing SVG" src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=000000&center=true&vCenter=true&width=600&lines=Hopeflow;AI+Short+Drama+Factory;Just+a+click%2C+novels+turn+into+episodes+in+seconds!" />
      </picture>
    </a>
  </p>
...
Hopeflow supports the following interface languages:
...
Hopeflow is an AI workstation designed for short drama production, building a complete closed loop around "Planning → Scriptwriting → Storyboarding → Final Output," supporting a localized, programmable, and continuously iterable production workflow.
...
[![Hopeflow 12-minute Quick Start AI Video](./videoCover.jpg)](https://www.bilibili.com/video/BV1oXD7BqEqJ)

**Hopeflow 12-minute Quick Start AI Video**
...
The following screenshots and video are from a short AI drama demo made with Hopeflow, completed in about 2 hours, covering script generation, storyboard creation, and editing.
...
| OS      | GitHub                                                       | Notes                         |
| :-----: | :----------------------------------------------------------- | :---------------------------- |
| Windows | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Official release package      |
| Linux   | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Official release package      |
| macOS   | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | Official release package      |
...
docker run -d -p <local_port>:10588 -v <local_data_path>:/app/data Hopeflow
...
pm2 logs Hopeflow-app # View logs
...
>
> **[AI Galaxy](https://www.ai-galaxy.com/)** is a **Hopeflow officially authorized commercial image provider**, offering a fully compliant, pre-built Hopeflow AI short-drama production image for commercial use — **ready to use out of the box, no manual deployment required**.
>
...
2. Select the image: `windows10LTSCwin10_Hopeflow` - Create Instance.
...
#### II. Configure Hopeflow & Start ComfyUI Stage

1. First configure the model used by the Agent: open Hopeflow on the desktop - Model Services - OpenAI-compatible interface - enter the API key and request URL.
   ...
   - After topping up, go to "Key Management" - New API, name it `Hopeflow` or anything you like, confirm, and copy the API key.
2. Back in step 1, paste the generated API key and request URL into Hopeflow's Model Services, then click elsewhere; the system will show "Provider configuration updated".
   ...
   Paste the full model name into Hopeflow and confirm to complete the model configuration.
...
>
> Developers are welcome to contribute to Hopeflow. If interested, please contact the maintainer ACT via email.
...
3. **Start Development Environment**
   ...
   - **Method 3: Production Mode**
     ...
     > Runs the compiled service in production mode (requires `pnpm build` first).
...
| ---------------- | ---------------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **Hopeflow-app** | Full client (this repo, recommended for regular users) | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-app) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-app) |
| **Hopeflow-web** | Frontend source code (for frontend developers) | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-web) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-web) |

> 💡 **Tip**: If you simply want to use Hopeflow, download the client from this repository. The frontend repository is for developers who need secondary development or UI customization.

---

# 💌 Contact Us

📧 Email: [ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=Hopeflow Inquiry)

---

# 📜 License

Hopeflow is open-sourced under the Apache-2.0 license, with supplementary commercial terms.
...
- Do not remove or modify any Hopeflow identifiers or copyright information.

## Permanent Free Use Cases

- ✅ Creating content with Hopeflow and receiving platform revenue shares
...
> **Non-retroactive clause**: Users who used Hopeflow under AGPL-3.0 before the v1.0.8 release will continue to be governed by AGPL-3.0 and are not affected by this agreement change.
...
We thank the following open-source projects for providing powerful support to Hopeflow:
