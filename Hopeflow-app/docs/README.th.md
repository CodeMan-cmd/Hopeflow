...
<div align="center">
  ...
  <p align="center">
    <a href="https://git.io/typing-svg" target="_blank">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=FFFFFF&center=true&vCenter=true&width=600&lines=Hopeflow;AI%E7%9F%AD%E5%89%A7%E5%B7%A5%E5%8E%82;%E5%8A%A8%E5%8A%A8%E6%89%8B%E6%8C%87%EF%BC%8C%E5%B0%8F%E8%AF%B4%E7%A7%92%E5%8F%98%E5%89%A7%E9%9B%86%EF%BC%81" />
        <img alt="Typing SVG" src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=3000&pause=1000&color=000000&center=true&vCenter=true&width=600&lines=Hopeflow;AI%E7%9F%AD%E5%89%A7%E5%B7%A5%E5%8E%82;%E5%8A%A8%E5%8A%A8%E6%89%8B%E6%8C%87%EF%BC%8C%E5%B0%8F%E8%AF%B4%E7%A7%92%E5%8F%98%E5%89%A7%E9%9B%86%EF%BC%81" />
      </picture>
    </a>
  </p>
...
Hopeflow รองรับอินเทอร์เฟซภาษาดังต่อไปนี้:
...
Hopeflow คือเวิร์กสเตชัน AI ที่มุ่งเน้นการผลิตซีรีส์สั้น สร้างวงจรปิดที่สมบูรณ์ตั้งแต่ "การวางแผน → การเขียนบท → การทำสตอรี่บอร์ด → การผลิตคลิป" และรองรับกระบวนการผลิตที่ปรับเปลี่ยนได้ในพื้นที่ สามารถตั้งโปรแกรมได้ และพัฒนาอย่างต่อเนื่อง
...
[![Hopeflow 12 นาที เริ่มต้นใช้งาน AI อย่างรวดเร็ว](./videoCover.jpg)](https://www.bilibili.com/video/BV1oXD7BqEqJ)

**Hopeflow 12 นาที เริ่มต้นใช้งาน AI อย่างรวดเร็ว**
...
ภาพหน้าจอและวิดีโอด้านล่างมาจากตัวอย่างซีรีส์สั้น AI ที่สร้างด้วย Hopeflow ใช้เวลาทั้งหมดประมาณ 2 ชั่วโมง ครอบคลุมการสร้างสคริปต์ การทำสตอรี่บอร์ด และการตัดต่อ
...
| :------: | :----------------------------------------------------------- | :------------- |
| Windows  | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | แพ็คเกจติดตั้งทางการ |
|  Linux   | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | แพ็คเกจติดตั้งทางการ |
|  macOS   | [Release](https://github.com/HBAI-Ltd/Hopeflow-app/releases) | แพ็คเกจติดตั้งทางการ |
...
docker run -d -p <พอร์ตท้องถิ่น>:10588 -v <เส้นทางข้อมูลท้องถิ่น>:/app/data Hopeflow
...
>
> **[Zhixing Cloud (AI Galaxy)](https://www.ai-galaxy.com/)** เป็น **ผู้ให้บริการอิมเมจเชิงพาณิชย์ที่ได้รับอนุญาตอย่างเป็นทางการจาก Hopeflow** ซึ่งได้ติดตั้ง เผยแพร่ และรองรับการใช้งานเชิงพาณิชย์ของอิมเมจการผลิตละครสั้น AI ของ Hopeflow แบบครบชุดอย่างถูกต้องตามกฎหมาย **พร้อมใช้งานทันที ไม่ต้องปรับใช้ด้วยตนเอง**
>
...
2. เลือกอิมเมจ: `windows10LTSCwin10_Hopeflow` - สร้างอินสแตนซ์
...
#### 2. ขั้นตอนการตั้งค่า Hopeflow และเริ่ม ComfyUI

1. ตั้งค่าโมเดลที่ Agent เรียกใช้ก่อน: เปิด Hopeflow บนเดสก์ท็อป - บริการโมเดล - อินเทอร์เฟซมาตรฐาน OpenAI - กรอกคีย์ API และที่อยู่คำขอ
   ...
   - หลังเติมเงินแล้ว เข้าไปที่ "จัดการ Key" - สร้าง API ใหม่ ตั้งชื่อว่า `Hopeflow` หรือชื่ออื่นก็ได้ คลิกยืนยันและคัดลอกคีย์ API
2. กลับไปที่ขั้นตอนที่ 1 วางคีย์ API และที่อยู่คำขอที่สร้างไว้ลงในบริการโมเดลของ Hopeflow กรอกเสร็จแล้วคลิกที่ว่าง ระบบจะแจ้งว่า "การกำหนดค่าผู้ให้บริการได้รับการอัปเดตแล้ว"
   ...
   วางชื่อโมเดลแบบเต็มลงใน Hopeflow และยืนยันเพื่อทำการตั้งค่าโมเดลให้เสร็จสมบูรณ์
...
>
> ยินดีต้อนรับนักพัฒนาทุกท่านร่วมสร้างสรรค์ Hopeflow หากสนใจเข้าร่วม โปรดติดต่อผู้ดูแล ACT ทางอีเมล
...
- **pnpm**: แนะนำให้ใช้เป็นตัวจัดการแพ็คเกจของโปรเจกต์
...
3. **เริ่มสภาพแวดล้อมการพัฒนา**
   ...
   - **วิธีที่ 3: เริ่มโหมดการผลิต**
     ...
     > รันบริการที่ compile แล้วโดยตรงในโหมดการผลิต (ต้องรัน `pnpm build` ก่อน)
...
| ---------------- | ---------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **Hopeflow-app** | ไคลเอนต์สมบูรณ์ (คลังนี้ แนะนำสำหรับผู้ใช้ทั่วไป) | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-app) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-app) |
| **Hopeflow-web** | ซอร์สโค้ดส่วนหน้า (เหมาะสำหรับนักพัฒนาส่วนหน้า)       | [GitHub](https://github.com/HBAI-Ltd/Hopeflow-web) | [Gitee](https://gitee.com/HBAI-Ltd/Hopeflow-web) |

> 💡 **คำแนะนำ**: หากคุณเพียงต้องการใช้ Hopeflow ให้ดาวน์โหลดไคลเอนต์จากคลังนี้โดยตรง คลังส่วนหน้ามีไว้สำหรับนักพัฒนาที่ต้องการพัฒนาเพิ่มเติมหรือปรับแต่งอินเทอร์เฟซส่วนหน้าเท่านั้น

---

# 💌 ติดต่อเรา

📧 อีเมล: [ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=สอบถาม Hopeflow)

---

# 📜 ใบอนุญาต

Hopeflow เผยแพร่ภายใต้สัญญาอนุญาต Apache-2.0 พร้อมข้อตกลงทางการค้าเพิ่มเติม
...
- ห้ามลบหรือแก้ไขเครื่องหมายหรือข้อมูลลิขสิทธิ์ใน Hopeflow

## สถานการณ์ที่ใช้งานฟรีถาวร

- ✅ ใช้ Hopeflow สร้างเนื้อหาและได้รับส่วนแบ่งรายได้จากแพลตฟอร์ม
...
ขอขอบคุณโครงการโอเพนซอร์สต่อไปนี้ที่ให้การสนับสนุนอย่างแข็งแกร่งแก่ Hopeflow:
...
ขอขอบคุณองค์กร/หน่วยงาน/บุคคลต่อไปนี้ที่ให้การสนับสนุน Hopeflow:
