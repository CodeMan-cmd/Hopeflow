<template>
  <div class="modeMenu">
    <div class="left f ac">
      ...
      <t-select size="small" class="langSelect" v-model="modelParmas.language">
        <t-option value="auto" :label="$t('workbench.generate.langAuto')" />
        <t-option value="system" :label="$t('workbench.generate.langSystem')" />
        <t-option v-for="lang in languageList" :key="lang.value" :value="lang.value" :label="lang.label" />
      </t-select>
    </div>
  </div>
</template>
