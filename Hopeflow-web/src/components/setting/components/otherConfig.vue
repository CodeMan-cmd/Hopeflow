<template>
  <div class="otherConfig">
    <t-form label-align="top">
      ...
      <t-form-item :label="$t('settings.other.taskAutoRefresh')">
        <t-switch v-model="otherSetting.taskAutoRefresh" />
      </t-form-item>
      <t-form-item v-if="otherSetting.taskAutoRefresh" :label="$t('settings.other.taskRefreshInterval')">
        <t-input-number
          auto-width
          :suffix="$t('settings.other.seconds')"
          :min="2"
          v-model="otherSetting.taskRefreshInterval"
          :allowInputOverLimit="false" />
      </t-form-item>
    </t-form>
  </div>
