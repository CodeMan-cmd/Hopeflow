    ...
    <div class="settingPanel">
      ...
      <div class="settingRight">
        ...
        <div class="settingContent">
          ...
          <safetyReplacements v-if="activeMenu === 'safetyReplacements'" />
          ...
          <gpuConfig v-if="activeMenu === 'gpuConfig'" />
          <sandboxConfig v-if="activeMenu === 'sandboxConfig'" />
...
import safetyReplacements from "./components/safetyReplacements.vue";
import memoryConfig from "./components/memoryConfig.vue";
import gpuConfig from "./components/gpuConfig.vue";
import sandboxConfig from "./components/sandboxConfig.vue";
...
const menuItems = [
  ...
  { key: "safetyReplacements", label: "settings.menu.safetyReplacements", icon: "i-shield" },
  ...
  { key: "gpuConfig", label: "settings.menu.gpuConfig", icon: "i-cpu" },
  { key: "sandboxConfig", label: "settings.menu.sandboxConfig", icon: "i-box" },
